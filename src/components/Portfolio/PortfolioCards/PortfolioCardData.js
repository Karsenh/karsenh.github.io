export const Projects = [
  ...
  },
  {
    ...
    platform: '(React.js)',
    description:
      'Developed basic web-based messaging application similar to Whatsapp using React.js and web-socket.io for real-time messaging.',
    link: 'https://github.com/Karsenh/React-Messaging-App',
  },
  {
    ...
    platform: '(React.js)',
    description:
      'React.js based web application for tracking wild-fires using NASAs open API.',
    link: 'https://github.com/ReactJs-Hyperbolic/Wildfire-Tracker',
  },
  {
